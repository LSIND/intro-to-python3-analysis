...
# открыть документ со значениями температур за промежуток времени 1tempdata.txt
...
# вывести значения температура -- количество повтроений, отсортированных по количеству повторений (по возрастанию)
